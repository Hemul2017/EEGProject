...
class Net(nn.Module):
    def __init__(self):
        ...
        self.cnn = nn.Conv1d(in_channels=4, out_channels=4, kernel_size=7, stride=4)
        self.lstm = nn.LSTM(input_size=4, hidden_size=4, num_layers=4, batch_first=True)
...
def main():
    ...
    epochs_dataset = EpochsDataset('./epochs_tensors_w_connectivity/imaginary')
